...
public class EstadosDeserializer extends JsonDeserializer<Estados>{

	
	@Override
	public Estados deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException,ApiException {
		final String estado = p.getText();
		if(StringUtils.isEmpty(estado))
			return null;
		final Estados e =  Estados.busca(estado);
		if(e!=null)
			return e;
