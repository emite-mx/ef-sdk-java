...
public class Deduccion implements Serializable {
	...
	@Pattern(regexp="^[^|]{3,15}$"
	,message="La clave no cumple con el patrón especificado por el SAT")
	...
	@Pattern(regexp="^[^|]{3,100}$"
		,message="El concepto no cumple con el patrón especificado por el SAT")
