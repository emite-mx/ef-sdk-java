...
@XmlType(name = "VehiculosUsadosEnajenadoPermAlFab10")
@Data
@Builder
@NoArgsConstructor @AllArgsConstructor

public class VehiculosUsadosEnajenadoPermAlFab implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -6813616608336276080L;
