...
public enum I_Api_Errores {
	...
	CRP202(40202,"CRP202 - El valor del campo FormaDePagoP debe ser distinto de \"99\".","El valor registrado debe ser diferente de 99."),
	CRP203(40203,"CRP203 - El campo MonedaP debe ser distinto de \"XXX\"","El atributo MonedaP debe ser diferente de \"XXX\"."),
	CRP204(40204,"CRP204 - El campo TipoCambioP se debe registrar. ","Si el atributo MonedaP es diferente de MXN, debe existir información en el atributo TipoCambioP."),
	CRP205(40205,"CRP205 - El campo TipoCambioP no se debe registrar. ","Si el atributo MonedaP es MXN, no debe existir información en el atributo TipoCambioP. "),
	CRP206(40206,"CRP206 - Cuando el valor del campo TipoCambioP se encuentre fuera de los límites establecidos, debe existir el campo Confirmacion","Cuando el valor de este atributo se encuentre fuera de los límites establecidos, el emisor debe obtener de manera no automática una clave de confirmación para ratificar que el valor es correcto e integrarla al CFDI en el atributo CFDI:Confirmacion. "),
	CRP207(40207,"CRP207 - La suma de los valores registrados en el campo ImpPagado de los apartados DoctoRelacionado no es menor o igual que el valor del campo Monto.","Que la suma de los valores registrados en el nodo DoctoRelacionado, atributo ImpPagado, sea menor o igual que el valor de este atributo."),
	CRP208(40208,"CRP208 - El valor del campo Monto no es mayor que cero \"0\".","Debe ser mayor a 0."),
	CRP209(40209,"CRP209 - El valor del campo Monto debe tener hasta la cantidad de decimales que soporte la moneda registrada en el campo MonedaP.","Considerar que para el monto, se debe registrar el número de decimales de acuerdo al tipo de moneda expresado en el atributo MonedaP, esto de acuerdo con la publicación del catálogo que se encuentra en la página de internet del SAT, en su caso, las cantidades deben ser redondeadas para cumplir con el número de decimales establecidos."),
	CRP210(40210,"CRP210 - Cuando el valor del campo Monto se encuentre fuera de los límites establecidos, debe existir el campo Confirmacion","Cuando el valor equivalente en MXN de este atributo exceda el límite establecido, el emisor debe obtener de manera no automática una clave de confirmación para ratificar que el importe es correcto e integrarla al CFDI en el atributo CFDI:Confirmacion. La clave de confirmación la asigna el PAC."),
	CRP211(40211,"CRP211 - El RFC del campo RfcEmisorCtaOrd no se encuentra en la lista de RFC.","Cuando no se utilice el RFC genérico XEXX010101000, el RFC debe estar en la lista de RFC inscritos en el SAT."),
	CRP212(40212,"CRP212 - El campo NomBancoOrdExt se debe registrar. ","Cuando se utilice el RFC genérico XEXX010101000 en el campo RfcEmisorCtaOrd, entonces el campo NomBancoOrdExt debe ser requerido."),
	CRP213(40213,"CRP213 - El campo CtaOrdenante no se debe registrar. ","Cuando el valor del campo FormaDePagoP sea diferente a la clave 02, 03, 04, 05, 06, 28 y 29, entonces este atributo no debe existir."),
	CRP214(40214,"CRP214 - El campo CtaOrdenante no cumple con el patrón requerido.","Si existe el atributo CtaOrdenante debe cumplir con el patrón especificado en el catálogo c_FormaPago"),
	CRP215(40215,"CRP215 - El campo RfcEmisorCtaBen no se debe registrar. ","Cuando el valor del campo FormaDePagoP sea diferente a la clave 02, 03, 04, 05, 28 y 29, entonces este atributo no debe existir."),
	CRP216(40216,"CRP216 - El campo CtaBeneficiario no se debe registrar. ","Cuando el valor del campo FormaDePagoP sea diferente a la clave 02, 03, 04, 05, 28 y 29, entonces este atributo no debe existir."),
	CRP217(40217,"CRP217 - El campo TipoCadPago no se debe registrar. ","SI el valor del atributo FormaDePagoP es diferente a la clave 03, el atributo TipoCadPago no debe existir."),
	CRP218(40218,"CRP218 - El valor del campo MonedaDR debe ser distinto de \"XXX\"","El atributo MonedaP debe ser diferente de \"XXX\"."),
	CRP219(40219,"CRP219 - El campo TipoCambioDR se debe registrar. ","Si el valor del atributo MonedaDR es diferente al valor registrado en el atributo MonedaP, se debe registrar información en el atributo TipoCambioDR."),
	CRP220(40220,"CRP220 - El campo TipoCambioDR no se debe registrar. ","Si el valor del atributo MonedaDR es igual al valor registrado en el atributo MonedaP, no se debe registrar información en el atributo TipoCambioDR. "),
	CRP221(40221,"CRP221 - El campo TipoCambioDR debe ser \"1\". ","Si el valor del atributo MonedaDR es MXN y el valor registrado en el atributo MonedaP es diferente a MEX, el atributo TipoCambioDR debe tener el valor \"1\". "),
	CRP222(40222,"CRP222 - El campo ImpSaldoAnt debe mayor a cero.","Debe ser mayor a cero"),
	CRP223(40223,"CRP223 - El valor del campo ImpSaldoAnt debe tener hasta la cantidad de decimales que soporte la moneda registrada en el campo MonedaDR.","Considerar que para los importes registrados en los atributos “ImpSaldoAnt”, “ImpPagado” e “ImpSaldoInsoluto” de éste nodo, deben corresponder a la moneda registrada en el campo MonedaDR y ser redondeados hasta la cantidad de decimales que soporte."),
	CRP224(40224,"CRP224 - El campo ImpPagado debe mayor a cero.","Debe ser mayor a cero"),
	CRP225(40225,"CRP225 - El valor del campo ImpPagado debe tener hasta la cantidad de decimales que soporte la moneda registrada en el campo MonedaDR.","Considerar que para los importes registrados en los atributos “ImpSaldoAnt”, “ImpPagado” e “ImpSaldoInsoluto” de éste nodo, deben corresponder a la moneda registrada en el campo MonedaDR y ser redondeados hasta la cantidad de decimales que soporte."),
	CRP226(40226,"CRP226 - El valor del campo ImpSaldoInsoluto debe tener hasta la cantidad de decimales que soporte la moneda registrada en el campo MonedaDR.","Considerar que para los importes registrados en los atributos “ImpSaldoAnt”, “ImpPagado” e “ImpSaldoInsoluto” de éste nodo, deben corresponder a la moneda registrada en el campo MonedaDR y ser redondeados hasta la cantidad de decimales que soporte."),
	CRP227(40227,"CRP227 - El campo ImpSaldoInsoluto debe ser mayor o igual a cero y calcularse con la suma de los campos ImSaldoAnt menos el ImpPagado o el Monto.","Debe ser mayor o igual a 0 y debe calcularse de los atributos: ImpSaldoAnt menos el ImpPagado, "),
	CRP228(40228,"CRP228 - El campo CertPago se debe registrar. ","Si existe el campo TipoCadPago es obligatorio registrar los campos \"CertPago\", \"CadPago\"  y \"SelloPago\"."),
	CRP229(40229,"CRP229 - El campo CertPago no se debe registrar. ","Si no existe el campo TipoCadPago no se deben registrar los campos \"CertPago\", \"CadPago\"  y \"SelloPago\"."),
	CRP230(40230,"CRP230 - El campo CadPago se debe registrar. ","Si existe el campo TipoCadPago es obligatorio registrar los campos \"CertPago\", \"CadPago\" y \"SelloPago\"."),
	CRP231(40231,"CRP231 - El campo CadPago no se debe registrar. ","Si no existe el campo TipoCadPago no se deben registrar los campos \"CertPago\", \"CadPago\" y \"SelloPago\"."),
	CRP232(40232,"CRP232 - El campo SelloPago se debe registrar. ","Si existe el campo TipoCadPago es obligatorio registrar los campos \"CertPago\", \"CadPago\"  y \"SelloPago\"."),
	CRP233(40233,"CRP233 - El campo SelloPago no se debe registrar. ","Si no existe el campo TipoCadPago no se deben registrar los campos \"CertPago\", \"CadPago\"  y \"SelloPago\"."),
	CRP234(40234,"CRP234 - El campo NumParcialidad se debe registrar. ","Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido."),
	CRP235(40235,"CRP235 - El campo ImpSaldoAnt se debe registrar. ","Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido. "),
	CRP236(40236,"CRP236 - El campo ImpPagado se debe registrar. ","Es obligatorio cuando exista más de un documento relacionado o cuando existe un documento relacionado y el TipoCambioDR tiene un valor."),
	CRP237(40237,"CRP237 - El campo ImpSaldoInsoluto se debe registrar. ","Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido."),
	CRP238(40238,"CRP238 - No debe exstir el apartado de Impuestos.","No debe existir el nodo impuestos para esta versión del complemento"),
