...
/**
 *  <h1>Operacion de timbrado de cfdi sellado en version 3.3</h1>
 *	
 * 
 * @author Enrique Sánchez de la Barquera
 *
 */
public class Nom33SelladorYTimbrador extends Operacion<SellarYTimbrarRequest,SellarYTimbrarResponse> {

	public Nom33SelladorYTimbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM33_SELLARYTIMBRAR);
	}

	
	
	/**
	 * Método que sella y timbra un comprobante de nómina cfdi 3.3 sellado en Base64
	 * 
