 ...
 *
 */
public class Cfdi33DescargaXml extends Operacion<XmlRequest,XmlResponse> {

	public Cfdi33DescargaXml(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_XML);
	}
