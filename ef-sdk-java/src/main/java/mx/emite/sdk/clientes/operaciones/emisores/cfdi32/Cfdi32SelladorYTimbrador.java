 ...
 *
 */
public class Cfdi32SelladorYTimbrador extends Operacion<SellarYTimbrarRequest,SellarYTimbrarResponse> {

	public Cfdi32SelladorYTimbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI32_SELLARYTIMBRAR);
	}
