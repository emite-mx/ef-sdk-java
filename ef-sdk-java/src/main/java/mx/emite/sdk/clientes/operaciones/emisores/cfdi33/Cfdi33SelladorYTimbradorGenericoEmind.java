 ...
 *
 */
public class Cfdi33SelladorYTimbradorGenericoEmind extends Operacion<SellarYTimbrarTxt33Request,SellarYTimbrarResponse> {

	public Cfdi33SelladorYTimbradorGenericoEmind(final ClienteJson cliente) {
		super(cliente,Proveedor.EMITEETL,Rutas.CFDI33_SELLARYTIMBRARGENERICOEMIND);
	}
