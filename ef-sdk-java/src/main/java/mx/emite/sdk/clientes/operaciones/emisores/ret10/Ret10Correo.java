 ...
 *
 */
public class Ret10Correo extends Operacion<CorreoRequest,CorreoResponse> {

	public Ret10Correo(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.RET10_CORREO);
	}
