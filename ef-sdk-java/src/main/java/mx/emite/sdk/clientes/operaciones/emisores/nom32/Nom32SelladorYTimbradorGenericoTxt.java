 ...
 *
 */
public class Nom32SelladorYTimbradorGenericoTxt extends Operacion<SellarYTimbrarTxtRequest,SellarYTimbrarResponse> {

	public Nom32SelladorYTimbradorGenericoTxt(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM32_SELLARYTIMBRARGENERICOTXT);
	}
