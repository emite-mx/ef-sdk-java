...
public class CancelaEmite extends Operacion<CancelarEmiteRequest,CancelarEmiteResponse>{

	
	@Deprecated
	public CancelaEmite(final ClienteJson cliente) {
		super(cliente,Proveedor.ENVIOCFDI,Rutas.CANCELAEMITE);
	}
