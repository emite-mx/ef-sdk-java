...
/**
 *  <h1>Operacion de envio de correos 3.3</h1>
 *	
 * 
 * @author Enrique Sánchez de la Barquera
 *
 */
public class Cfdi33Correo extends Operacion<CorreoRequest,CorreoResponse> {

	public Cfdi33Correo(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_CORREO);
	}
