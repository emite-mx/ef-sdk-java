...
/**
 *  <h1>Operacion de cancelación de cfdi version 3.3</h1>
 *	
 * 
 * @author Enrique Sánchez de la Barquera
 *
 */
public class Nom33Cancelador extends Operacion<CancelarRequest,CancelarResponse> {

	public Nom33Cancelador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM33_CANCELAR);
	}

	
	
	/**
	 * Método que cancela un comprobante cfdi 3.3
	 * 
