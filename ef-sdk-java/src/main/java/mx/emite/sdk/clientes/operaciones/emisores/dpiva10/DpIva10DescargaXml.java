 ...
 *
 */
public class DpIva10DescargaXml extends Operacion<XmlRequest,XmlResponse> {

	public DpIva10DescargaXml(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.DPIVA10_XML);
	}
