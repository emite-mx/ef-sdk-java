...
/**
 *  <h1>Operacion de descarga de acuse de cancelación 3.3 </h1>
 *	
 * 
 * @author Enrique Sánchez de la Barquera
 *
 */
public class Cfdi33PdfAcuse extends Operacion<PdfRequest,PdfResponse> {

	public Cfdi33PdfAcuse(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_PDFACUSE);
	}
