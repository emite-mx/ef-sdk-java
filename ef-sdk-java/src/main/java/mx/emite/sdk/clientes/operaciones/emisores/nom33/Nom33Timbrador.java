...
/**
 *  <h1>Operacion de timbrado de cfdi de nómina sellado en version 3.3</h1>
 *	
 * 
 * @author Enrique Sánchez de la Barquera
 *
 */
public class Nom33Timbrador extends Operacion<TimbrarRequest,TimbrarResponse> {

	public Nom33Timbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM33_TIMBRAR);
	}

	
	
	/**
	 * Método que sella y timbra un comprobante cfdi de nómina 3.3 sellado en Base64
	 * 
