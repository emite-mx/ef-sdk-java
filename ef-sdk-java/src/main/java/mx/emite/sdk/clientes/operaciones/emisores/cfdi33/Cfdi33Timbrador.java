 ...
 *
 */
public class Cfdi33Timbrador extends Operacion<TimbrarRequest,TimbrarResponse> {

	public Cfdi33Timbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_TIMBRAR);
	}
