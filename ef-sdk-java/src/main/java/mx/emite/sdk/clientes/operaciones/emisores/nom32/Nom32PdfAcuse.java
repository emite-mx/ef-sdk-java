 ...
 *
 */
public class Nom32PdfAcuse extends Operacion<PdfRequest,PdfResponse> {

	public Nom32PdfAcuse(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM32_PDFACUSE);
	}
