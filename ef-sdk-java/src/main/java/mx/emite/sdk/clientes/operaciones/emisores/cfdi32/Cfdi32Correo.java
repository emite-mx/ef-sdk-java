 ...
 *
 */
public class Cfdi32Correo extends Operacion<CorreoRequest,CorreoResponse> {

	public Cfdi32Correo(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI32_CORREO);
	}
