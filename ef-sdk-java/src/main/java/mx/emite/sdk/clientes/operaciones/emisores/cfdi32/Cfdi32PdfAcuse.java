 ...
 *
 */
public class Cfdi32PdfAcuse extends Operacion<PdfRequest,PdfResponse> {

	public Cfdi32PdfAcuse(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI32_PDFACUSE);
	}
