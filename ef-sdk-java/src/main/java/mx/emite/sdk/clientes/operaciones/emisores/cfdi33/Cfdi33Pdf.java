 ...
 *
 */
public class Cfdi33Pdf extends Operacion<PdfRequest,PdfResponse> {

	public Cfdi33Pdf(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_PDF);
	}
