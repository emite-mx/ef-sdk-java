 ...
 *
 */
public class Cfdi33SelladorYTimbrador extends Operacion<SellarYTimbrarRequest,SellarYTimbrarResponse> {

	public Cfdi33SelladorYTimbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_SELLARYTIMBRAR);
	}
