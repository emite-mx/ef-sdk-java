 ...
 *
 */
public class Nom32Correo extends Operacion<CorreoRequest,CorreoResponse> {

	public Nom32Correo(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.NOM32_CORREO);
	}
