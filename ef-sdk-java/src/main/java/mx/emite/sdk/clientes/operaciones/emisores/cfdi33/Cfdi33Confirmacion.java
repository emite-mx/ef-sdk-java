 ...
 *
 */
public class Cfdi33Confirmacion extends Operacion<ConfirmacionRequest,ConfirmacionResponse> {

	public Cfdi33Confirmacion(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_CONFIRMACION);
	}
