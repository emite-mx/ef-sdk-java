...
public class CancelaRetMasivaEmite extends Operacion<CancelarEmiteRequest,CancelarEmiteResponse>{

	
	@Deprecated
	public CancelaRetMasivaEmite(final ClienteJson cliente) {
		super(cliente,Proveedor.ENVIOCFDI,Rutas.CANCELARETMASIVAEMITE);
	}
