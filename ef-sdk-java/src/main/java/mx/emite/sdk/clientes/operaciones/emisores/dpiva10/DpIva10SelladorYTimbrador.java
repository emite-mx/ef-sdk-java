 ...
 *
 */
public class DpIva10SelladorYTimbrador extends Operacion<SellarYTimbrarRequest,SellarYTimbrarResponse> {

	public DpIva10SelladorYTimbrador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.DPIVA10_SELLARYTIMBRAR);
	}
