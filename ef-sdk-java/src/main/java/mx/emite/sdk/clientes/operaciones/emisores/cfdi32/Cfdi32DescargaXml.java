 ...
 *
 */
public class Cfdi32DescargaXml extends Operacion<XmlRequest,XmlResponse> {

	public Cfdi32DescargaXml(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI32_XML);
	}
