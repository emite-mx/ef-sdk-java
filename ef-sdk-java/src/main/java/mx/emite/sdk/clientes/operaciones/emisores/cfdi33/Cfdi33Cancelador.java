 ...
 *
 */
public class Cfdi33Cancelador extends Operacion<CancelarRequest,CancelarResponse> {

	public Cfdi33Cancelador(final ClienteJson cliente) {
		super(cliente,Proveedor.PROXY,Rutas.CFDI33_CANCELAR);
	}
